...
% Neural Network.   (Part 1 out of 4 projects)	    				      %
%                                                                         %
...
steerAngle = [40*ones(1,20) 30*ones(1,20) 20*ones(1,20) 10*ones(1,20) ...
             -10*ones(1,20) -20*ones(1,20) -30*ones(1,20) -40*ones(1,20) ]* pi/180; %[Degrees] Counter Clock Wise (Useless Intial Value)
