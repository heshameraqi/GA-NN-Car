...
% Neural Network.   (Part 2 out of 4 projects)	    				      %
%                                                                         %
...
video_saving = 0;                                  % Video saving (Makes simulation slower)
%% Environment Configurations
env.nbrOfCars = 1;
width = 15;
width = width*4;
env.dx_dy = [width 150 150 150 -400 150 150 400 -150 -200 -150 400 400 150 -1000 -150 200 -150 -400 -150 200 -300 150 300 150 -400 -400 -400 width ...
    400-width 400 400+2*width -150-2*width -300 -150+2*width 300 -200 150-2*width 400 150+2*width -200 150-2*width 1000-2*width -150+2*width -400 -400-2*width 150+2*width 200 150-2*width -400+2*width -150 -150-2*width 400 -150+2*width -150 -150-width width];
env.dx_dy = env.dx_dy/5;
